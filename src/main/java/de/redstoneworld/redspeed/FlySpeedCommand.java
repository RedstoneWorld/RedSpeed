...
public class FlySpeedCommand {
	 ...
	 * fly speed value to the default value.
	 */
	...
	/**
	 * This method allow to SET the own
	 * fly speed value to the requested value.
	 */
	public boolean setSpecificSpeed(float x) {
		...
		player.sendMessage(plugin.getLang("präfix") + plugin.getLang("success-fspeed.ownSpecificValue", "fspeed", String.valueOf(x)));
		return true;
	...
	/**
	 * This method allow to SHOW fly speed value
	 * of another player.
	 */
	public boolean sendFlySpeedMsgOther() {
		...
		float fs = player.getFlySpeed();
		sender.sendMessage(plugin.getLang("präfix") + plugin.getLang("show.fspeed-other", "name", targetName, "fspeed", String.valueOf(fs)));
		return true;

	}

	/**
	 * This method allow to SET fly speed value
	...
	public boolean setDefaultSpeedOther() {
		...
		player.setFlySpeed(DEFAULT_FLY_SPEED);
		if (sender != player) {
		sender.sendMessage(plugin.getLang("präfix") + plugin.getLang("success-fspeed.other", "name", targetName, "fspeed", String.valueOf(DEFAULT_FLY_SPEED)));
		}
		player.sendMessage(plugin.getLang("präfix") + plugin.getLang("success-fspeed.ownDefaultValue"));
		return true;
	...
	public boolean setSpecificSpeedOther(float x) {
		...
		player.setFlySpeed(x);
		if (sender != player) {
			sender.sendMessage(plugin.getLang("präfix") + plugin.getLang("success-fspeed.other", "name", targetName, "fspeed", String.valueOf(x)));
		}
		player.sendMessage(plugin.getLang("präfix") + plugin.getLang("success-fspeed.ownSpecificValue", "fspeed", String.valueOf(x)));
		return true;
	 ...
	 * SHOW or SET the fly speed value of him.
	 */
